        ...
        <div id="main">
            ...
            <div id="banner">
				...
				<ul style="background-color:gray;color:white; font-weight:bold;">
					<li style="background-color:black;"><p>興趣</p></li>
					<form method="POST" id="submit">
					<textarea style="width:500px;height:200px;" name="interest"  id="interest" ><?php echo $user_data['interest']?></textarea>
					</br>
