...
<body>
    <div id="page" class="container">
        <div id="header">
            ...
            <div id="menu">
                <ul>
                    ...
                    <li><a href="index2.php" accesskey="4" title="">Brunch早午餐</a></li>
                    <li><a href="#" accesskey="5" title="">Drinks飲料</a></li>
        ...
        <div id="main">
            <div id="banner">
                <img src="image/drinks.jpg" alt="" class="image-full" />
            </div>
            <div id="welcome">
                <div class="title">
                    <h2>飲料店文章列表</h2>
                    <span class="byline">有喜歡的飲料店歡迎分享給大家知道</span>
                </div>
                ...
                <div id="list">
                    <!--    PHP Part Start    -->
                    <?php
                        $sql = "SELECT * FROM `article` natural join `user` WHERE type='drinks' ORDER BY `article_ID`DESC";
    ...
    <script>
        ...
        function change() {
            ...
            if(c==true)
            {
                sql="SELECT * FROM `article` natural join `user` WHERE type='drinks' ORDER BY `article_ID`";
                c=false;
            }
            else
            {
        ...
        function change_title() {
            ...
            if(b==true)
            {
                sql="SELECT * FROM `article` natural join `user` WHERE type='drinks' ORDER BY `title`";
                b=false;
            }
            else
            {
                sql = "SELECT * FROM `article` natural join `user` WHERE type='drinks' ORDER BY `title`DESC";
                b=true;
            }
        ...
        function change_pageview() {
            ...
            if(a==true)
            {
                sql="SELECT * FROM `article` natural join `user` WHERE type='drinks' ORDER BY `page_views`DESC";
                a=false;
            }
            else
            {
                sql = "SELECT * FROM `article` natural join `user` WHERE type='drinks' ORDER BY `page_views`";
                a=true;
            }
